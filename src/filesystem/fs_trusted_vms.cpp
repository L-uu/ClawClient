...
#define SHA(b0, b1, b2, b3, b4, b5, b6, b7)                            \
    {                                                                  \
        0x##b0, 0x##b1, 0x##b2, 0x##b3, 0x##b4, 0x##b5, 0x##b6, 0x##b7 \
    }
...
static const unsigned int trusted_vms[][8] = {
    ...
    // Defrag
    SHA(72d9fcff, db4e6650, f50c284a, e8ca9626, c47f6e95, a81c201a, 41f599e5,
        4e82d599),  // 1.91.08 zz-defrag_vm_191.pk3 cgame
    SHA(4d5cf74a, 5e25367d, 6d14edfb, 06b8b62b, 4da4a08f, 7507d898, b7c8f830,
        a3e85aca),  // 1.91.08 zz-defrag_vm_191.pk3 ui
    SHA(5e5de89f, 68c8e5c9, 4bd6a9d6, a1536c6e, 1cf4b1b3, a9a3feac, 701a0067,
        dab1c3a6),  // 1.91.08 zz-defrag_vm_191.pk3 qagame
    SHA(e0241055, 9cad5dfd, bbfe07e8, 2d285df1, 7ccbbebb, 7c713c57, 2053c01f,
        524d2ad6),  // 1.91.09 zz-defrag_vm_191.pk3 cgame
    SHA(6c66c6fe, 83394dc7, caf3c208, 1ad2fecc, 53882ac4, 4e1efa7b, da88e164,
        ac28b05f),  // 1.91.09 zz-defrag_vm_191.pk3 ui
    SHA(cbac543e, c646241a, 94b725d1, 6cee4d6c, b2ed7c21, 44097365, cdfce365,
        f3ecbd18),  // 1.91.09 zz-defrag_vm_191.pk3 qagame
    SHA(4de95184, aa5e4a6e, 6e0c67a8, 16719a59, c5be4192, 14977391, cc5da990,
        2e35f030),  // 1.91.12 zz-defrag_vm_191.pk3 cgame
    SHA(5312ecd0, b18c704b, 4d37001a, 63387d08, 6f8dfabf, 0af91a7f, fab1eed3,
        71e6d857),  // 1.91.12 zz-defrag_vm_191.pk3 ui
    SHA(76c97520, 32c4b7a1, 427c0e75, a7b9427a, 18cc88d7, 28fd6109, f9d03c73,
        eb88fc62),  // 1.91.12 zz-defrag_vm_191.pk3 qagame
    SHA(dad41168, cd655d7c, b04d4ee4, bf55166e, 0447a92c, f0d3d068, 8cd903d1,
        14645f98),  // 1.91.13 zz-defrag_vm_191.pk3 cgame
    SHA(f19e47e9, 728ff36d, 6c0558f0, 2d742102, 37675ab4, 3f21ea1d, 6341dcc6,
        3b9cdcbe),  // 1.91.13 zz-defrag_vm_191.pk3 ui
    SHA(8563ec68, 5588591c, 6f06126e, bd3345e7, b70ce9ed, 8b8e809d, c712e4db,
        915b3c57),  // 1.91.13 zz-defrag_vm_191.pk3 qagame
    SHA(ef0558ed, 5ba81cbc, 18234a58, 6b3adc7e, b4b8609f, 02127637, 234c5655,
        19bd00f4),  // 1.91.14 zz-defrag_vm_191.pk3 cgame
    SHA(e057a5ff, 44fd6ff5, 5012c35a, 3106c2fc, ee68e0a0, 4d660839, 9b36ec25,
        344fb802),  // 1.91.14 zz-defrag_vm_191.pk3 ui
    SHA(61f04e71, 3b4cdc94, 5ea6e532, 54a65d1e, a21a40c7, e9825379, 39509b68,
        5128bc62),  // 1.91.14 zz-defrag_vm_191.pk3 qagame
    SHA(9a4f85b5, 3baa0e96, 57c3c0b3, a1af8eb2, d2f96954, 1b7a5d03, e9117e74,
        82989e1b),  // 1.91.15 zz-defrag_vm_191.pk3 cgame
    SHA(d758b933, f8454fe9, 52ff65fa, c6dddf6f, 4a9d5151, c3e107ca, 33253f00,
        14770c06),  // 1.91.15 zz-defrag_vm_191.pk3 ui
    SHA(b86f1d8d, c93c4330, 581ec14a, 6867bf9b, c287ab8a, 6ca139ec, ae78900a,
        ae022dfa),  // 1.91.15 zz-defrag_vm_191.pk3 qagame
    SHA(4a446c8c, 93fd97c6, 85940fd0, 813f4745, a32b3f96, dc7c47ac, f627a2de,
        490b224a),  // 1.91.16 zz-defrag_vm_191.pk3 cgame
    SHA(ef636acb, a99eede9, 4f420ef3, 481702d1, 65ad6b25, c9eb4c0f, b0ba5867,
        7e0beb53),  // 1.91.16 zz-defrag_vm_191.pk3 ui
    SHA(32054981, 8ace1ea9, 428097f1, d8c13a9a, e5261853, e9edfb1f, fc306e6b,
        7123677a),  // 1.91.16 zz-defrag_vm_191.pk3 qagame
    SHA(14a5d251, 5c018ca7, 0fdc76a8, cc1d858f, 3720807f, 798e7990, b5524f74,
        582ea81b),  // 1.91.17 zz-defrag_vm_191.pk3 cgame
    SHA(58766e5d, 9e592f51, 9ba09d85, cc3f1083, a03f0a64, fc3b1d88, 95826420,
        594634ac),  // 1.91.17 zz-defrag_vm_191.pk3 ui
    SHA(ce8a1695, 7df90e1d, 25b4afa0, 2e91a61e, 2b7f3e07, f7a4d1c5, a0c461b1,
        2c4d3cc2),  // 1.91.17 zz-defrag_vm_191.pk3 qagame
    SHA(01b34f3b, 94a9d62b, 6bb17cfa, 40ab1216, 2370f30a, 02afd238, 9b2e7974,
        3f4fe2af),  // 1.91.18 zz-defrag_vm_191.pk3 cgame
    SHA(f3f5495d, c00bca5e, 6e3b601a, 77bf73a1, 04a367b2, deafa199, 7fbcd8ff,
        a7ed1edd),  // 1.91.18 zz-defrag_vm_191.pk3 ui
    SHA(be70f4d7, eb488016, eb777b2c, 42c1bb77, 34bee663, d08465d6, e4443115,
        8e5e198c),  // 1.91.18 zz-defrag_vm_191.pk3 qagame
    SHA(70ec42d0, 50364cfd, ee5ebd50, 5b8af875, 499a60c7, 9a251935, f68490c7,
        2d787640),  // 1.91.19 zz-defrag_vm_191.pk3 cgame
    SHA(d646b072, a6717648, 6c254bbe, cb5e2a6a, e1df3ec8, 7f83fb84, 4f5cc359,
        f9a35550),  // 1.91.19 zz-defrag_vm_191.pk3 ui
    SHA(a81b8fab, 2b3057e4, cc6ae201, 9bc2ccca, c8e83902, ccdb5f7d, d2ca2952,
        a3a6eed8),  // 1.91.19 zz-defrag_vm_191.pk3 qagame
    SHA(e7551948, ac4c5fc5, d50640a6, 0a336b58, ec1fc6b1, cc572e6c, 337f0ec3,
        9fb5b35b),  // 1.91.20 zz-defrag_vm_191.pk3 cgame
    SHA(72e9f3fb, af044bcf, 88f4e897, 57512f76, cc74abad, 398fa12f, a978cd82,
        52c83077),  // 1.91.20 zz-defrag_vm_191.pk3 ui
    SHA(553bc0f2, 9c2e4d05, 14ec720a, 1bb0a276, 95b79d72, 0eaf3305, 3091912b,
        70ead9ef),  // 1.91.20 zz-defrag_vm_191.pk3 qagame
    SHA(33c33558, c63a0a2c, 06bf813e, 9f37f7b8, 7fbf6e38, d517c0f4, bab119ab,
        fa2cec03),  // 1.91.21 zz-defrag_vm_191.pk3 cgame
    SHA(efb2d97c, 4523f370, c50ad8ce, 65b416cc, 804de272, fc7b818f, a3cf4d08,
        b95991c8),  // 1.91.21 zz-defrag_vm_191.pk3 ui
    SHA(04877cfc, 1e769450, e39d841d, bfdf61a4, 8648b7a6, a2d2e928, 179b11d1,
        3dec500b),  // 1.91.21 zz-defrag_vm_191.pk3 qagame
    SHA(224222a1, b435210a, ea2a980f, 510e626a, bd9e0956, 749840b3, 0fb7e039,
        726b9aca),  // 1.91.22 zz-defrag_vm_191.pk3 cgame
    SHA(0bc890e4, 5eaa190e, 6c1a1735, 3da7794d, 5a3ba898, 90f99397, e7a947ac,
        ce80e75c),  // 1.91.22 zz-defrag_vm_191.pk3 ui
    SHA(fd83b123, a5d5a243, 0007d0c6, 074070db, d8c03aa1, bfde3684, 365ea60e,
        d86f6c3e),  // 1.91.22 zz-defrag_vm_191.pk3 qagame
    SHA(753a4747, c0e7e2b7, f0172ee2, 2bca1f84, 56f90e81, 5940a36a, f79ba4be,
        44bb57ab),  // 1.91.23 zz-defrag_vm_191.pk3 cgame
    SHA(52a45d3e, c13533fe, 7cd458a0, 1a787b03, ec6e111a, 61fbbe94, 9328b5e8,
        f1e39159),  // 1.91.23 zz-defrag_vm_191.pk3 ui
    SHA(114edd74, 03235177, 8eff4f2d, 6dce9494, 34f693ec, feda608d, 3d7a53c6,
        dc9b97e1),  // 1.91.23 zz-defrag_vm_191.pk3 qagame
    SHA(f7f814f4, f5960606, 85f3c4f2, 74d994e9, 85014b3f, 91b699ac, bc948089,
        34b990af),  // 1.91.24 zz-defrag_vm_191.pk3 cgame
    SHA(4b38aac9, ab6b7626, 692cead2, 810ad1a7, 9aea7525, 257d154d, 7e786a79,
        b777a46a),  // 1.91.24 zz-defrag_vm_191.pk3 ui
    SHA(3aefd360, e9dce2bd, f4bddc95, 7e08d1c6, d20cc059, f0500bf3, 71a6eb42,
        01b32f88),  // 1.91.24 zz-defrag_vm_191.pk3 qagame
    SHA(b950f4d7, 895cc4ff, f12877ec, 7f120746, 0b5db3ad, 6c0ecf1c, 44f732b8,
        c734344e),  // 1.92.00 zz-defrag_vm_192.pk3 cgame
    SHA(646e8473, 354906fd, 6a874c90, eaa198c6, 127d5193, 89702b63, 71e35321,
        32010b4e),  // 1.92.00 zz-defrag_vm_192.pk3 ui
    SHA(e8fc046c, cf168b9a, 15c45e8c, 600913f3, e6b30b36, 691ea45a, b087c6ce,
        5af8a846),  // 1.92.00 zz-defrag_vm_192.pk3 qagame
    SHA(5ebedeb4, 840ce409, 0a2ebce2, 0836514c, 74bd6913, 890bb877, 3c567ad7,
        f8c6b868),  // 1.92.01 zz-defrag_vm_192.pk3 cgame
    SHA(e3b23641, 46899012, 12cc5da1, 2416a1b1, 40267dd3, b421247b, 3bdc4e97,
        ff61b6e6),  // 1.92.01 zz-defrag_vm_192.pk3 ui
    SHA(8191934f, 8f9f49de, 0bb4942b, 70acf9fc, 22b4a921, c72fc0c3, 3e85cdcb,
        243c18de),  // 1.92.01 zz-defrag_vm_192.pk3 qagame
    SHA(a785d303, 4443f3fb, 47ff81c9, dcf7520f, cb025bcb, 09d947f4, 52fdd9e6,
        263adb3f),  // 1.92.02 zz-defrag_vm_192.pk3 cgame
    SHA(f7c7edea, 6e95a626, 25a6f958, 8c559edb, 07030c88, 9984bdde, 47d77d62,
        819a75ab),  // 1.92.02 zz-defrag_vm_192.pk3 ui
    SHA(e6af8c30, 17e1fa32, cdc38444, 7491017b, 7b12d5dc, 73c0662e, c69a294d,
        5748e117),  // 1.92.02 zz-defrag_vm_192.pk3 qagame
    ...
    SHA(7039ee45, 20113948, ec5a26b1, e22c88ce, 164574c5, ba24240f, 8d062ccb,
        4a096143),  // z-Revolution-client-200[Epsilon2].pk3 cgame
    SHA(9c12d1da, c8865664, f580c4e1, 5c6195af, b2195197, 4c039319, 05636f07,
        b624dcd2),  // z-Revolution-server-200[Epsilon2].pk3 qagame
    SHA(8c62e928, d0fa7a67, 672bdca8, 32fc4db8, da5800b6, 41270db7, 6bde0326,
        e2a5b256),  // z-Revolution-client-200[Epsilon1].pk3 cgame
    SHA(1f42801b, 6faa1cba, 60c14757, bade8001, 4be2218f, 3b52685e, 6256668f,
        a0e36251),  // z-Revolution-ui-200[Epsilon1].pk3 ui
    SHA(a7da4d5f, 93fc9c07, b018b92d, 91e17dcc, c00f898f, 2654664e, b41ffc6c,
        771cfc7b),  // z-Revolution-server-200[Epsilon1].pk3 qagame
    SHA(e5d17064, 445a52b7, 5619418c, 2c43251a, 7b589ab3, f6ec3adc, 949697da,
        86680a1d),  // z-Revolution-client-200[Delta6].pk3 cgame
    SHA(d5c75915, 6311193e, 047e8a95, 4ff24cd4, b59f60f1, a49e1eed, dc4bdfa8,
        fb15a793),  // z-Revolution-server-200[Delta6].pk3 qagame
    SHA(35939d6e, a6aec584, f97939f4, 1f9bb4b4, 8f8dc4d8, 8ea8c07b, 278cd14c,
        12fbb4e1),  // z-Revolution-ui-200[Chi1].pk3 ui
    SHA(e3ea6e17, 2c73cee8, 1f3601e8, a0fe50ee, aa117fd0, 9dd1948c, 3182e3a2,
        ddb600be),  // z-Revolution-client-200[Beta1].pk3 cgame
    SHA(8032d831, 00c51e60, 7d57d221, a36755fe, c8b374a2, 67059c06, 5beceb93,
        7369621f),  // z-Revolution-server-200[Beta1].pk3 qagame
    SHA(0d90b458, 0bfd1f09, 7a1d9d11, de223475, 39beacdd, ac0b62d1, 7e8637d5,
        50c0a20b),  // z-Revolution-200[Alpha1].pk3 cgame
    SHA(02e9bd52, 92119cc0, 75822413, 91a2b7ee, c1c6b2b3, 5f5aa34f, e22e745a,
        ca1cf49d),  // z-Revolution-200[Alpha1].pk3 ui
    SHA(4904e60c, 6d914309, 266c7f97, 97f7009c, e286c128, aa2738c7, dcf7049c,
        d72d7952),  // z-Revolution-200[Alpha1].pk3 qagame
